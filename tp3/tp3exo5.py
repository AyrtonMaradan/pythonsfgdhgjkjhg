...
if 0<=a<b<=7 :
    heure= b-a
    print("Vous avez loué votre vélo pendant \n " , heure , " heure à un tarif à 1EU/h . \n Le montant total est de", heure , "EURO")
elif 17<a<b<=24 :
    heure = b - a
    print("Vous avez loué votre vélo pendant \n ", heure , " heure à un tarif à 1EU/h . \n Le montant total est de", heure , "EURO")
elif 7<a<b<=17 :
    heure = (b-a)
    tarif = (b-a)*2
    print("Vous avez loué votre vélo pendant \n ", heure , " heure à un tarif à 2EU/h . \n Le montant total est de", tarif , "EURO")
    ...
    e= (b-7)
    tarif = c + d
    print("Vous avez loué votre vélo pendant \n ", e, " heure à un tarif à 2EU/h . \n " , c , " heure à un tarif à 1EU/h .\n Le montant total est de",
    tarif, "EURO")
    ...
    e = (b - 17)
    tarif = e + d
    print("Vous avez loué votre vélo pendant \n ", c, " heure à un tarif à 2EU/h . \n ",e,
          " heure à un tarif à 1EU/h .\n Le montant total est de",
          tarif, "EURO")
